            ...
            <div className='flex justify-center px-4 py-14 mt-20'>
                ...
                >
                    <div className='mb-10'>
                        ...
                        <p className='text-zinc-500 mt-1'>Manage your AI chatbot knowledge ans bussiness details</p>
                    </div>
                    ...
                    <div className='mb-10'>
                        ...
                        <p className='text-sm text-zinc-500 mb-4'>Add, policies, delivery info, refunds, etc.</p>
                        <div className='space-y-4'>
                            <textarea className='w-full h-54 rounded-xl border border-zinc-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-black/80' placeholder={`Example:
                                ...
                                Support hour`} onChange={(e) => setKnowledge(e.target.value)} value={knowledge} />
                        </div>
                    </div>
