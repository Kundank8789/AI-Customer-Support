        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-semibold leading-tight">
              AI Customer Support <br /> Built for Modern websiteS</h1>
            <p className="mt-6 text-lg text-zinc-600 max-w-xl">Add a poweful AI chatbot to your website in minutes.
              Let your customers get instant answers to their questions, 24/7, with our easy-to-use platform. No coding required.
            </p>
          ...
          >
            <div className="rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6">
              <div className="text-sm text-zinc-500 mb-3">Live Chart Preview</div>
